    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Designations')" class="grid">
                ...
                <flux:navlist.item icon="plus" :href="route('designations.create')" :current="request()->routeIs('designations.create')" wire:navigate>{{ __('Create Designation') }}</flux:navlist.item>
            </flux:navlist.group>
            ...
            <flux:navlist.group :heading="__('Contracts')" class="grid">
                ...
                <flux:navlist.item icon="users" :href="route('contracts.create')" :current="request()->routeIs('contracts.create')" wire:navigate>{{ __('Create Contract') }}</flux:navlist.item>
            </flux:navlist.group>
        ...
        <flux:dropdown>
            <flux:profile
                :name="App\Models\Company::find(id: session(key: 'company_id'))->name??'Select Company'"
                :initials="App\Models\Company::find(id: session(key: 'company_id'))->initials??'N/A'"

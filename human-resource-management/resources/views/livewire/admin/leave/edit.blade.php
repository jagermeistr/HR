            ...
            <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Edit Leave Request</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400">Update leave request details</p>
                        </div>
                        <a 
